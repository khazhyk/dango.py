...
class CogDefaultGrants:
    ...
    A cog configures this by
    """

class ConfigGrants:
    """Represents overrides given for a specific guild."""

def resolve_grants():
    pass

class ResolvedGrants:
    """Represents a fully-resolved permission structure for a guild.
    
    To save memory, if permission node is default_allow, it isn't stored here.
    """

    def __init__(self, guild_grants, permission_grants, role_grants, member_grants):
        pass

    def member_allowed(self, member):
        pass
